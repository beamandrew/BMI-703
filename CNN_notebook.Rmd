...
model %>%
  ...
  layer_conv_2d(filters = 16, kernel_size = c(3,3), activation = 'relu', input_shape = c(64,64,3),padding = "same") %>% 
...
## In class assignment
Now it's your turn again to improve upon this model. Here are some suggestions:
